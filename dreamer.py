...
def random_sample(iterations):
    low = iterations - 20
    high = iterations
    new_iterations = np.random.randint(low=low,high=high)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', '--random', help='random sampling of iterations within range', type=int, required=False)
    ...
    if args.extract is 1:
        ...
        main(args.input, args.output, args.preview, args.octaves, args.octavescale, args.iterations, args.jitter,
             args.zoom, args.stepsize, args.blend, args.layers, args.guide, args.gpu, args.flow, args.random)
